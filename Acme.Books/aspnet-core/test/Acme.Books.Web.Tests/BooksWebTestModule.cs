...
namespace Acme.Books
{
    [DependsOn(
        ...
        typeof(BooksWebModule),
        typeof(BooksApplicationTestModule)
    )]
    public class BooksWebTestModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                builder.PartManager.ApplicationParts.Add(new AssemblyPart(typeof(BooksWebModule).Assembly));
            });
        }
