...
namespace Acme.BookStore.Web
{
    ...
    public class BookStoreWebModule : AbpModule
    {
        ...
        {
            // var migrations = context.ServiceProvider.GetRequiredService<DataContext>().Database.GetMigrations();
            //context.ServiceProvider.GetRequiredService<BookStoreDbMigrationService>().MigrateAsync();
